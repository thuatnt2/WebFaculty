...
<div id="formbox"> 
    ...
    <form method="POST" action="" enctype="multipart/form-data">     
        ...
        <div class="form-regit">
            <textarea rows="5" cols="42" name="noidung" id="noidung"><?php echo $row1['noidung']; ?></textarea>
        ...
        <div class="form-regit">
            ...
            <?php
            if (isset($_GET['sua'])) {?>
            <div style="float:left;padding: 20px 10px 0 0;"><a href="?mod=updateTin&act=edit&id=<?php echo $_GET['id']; ?>"> Không sửa ảnh</a></div>
                <div style="float:left;padding: 5px 0 0 500px;"><input type="file" name="fileUpload" id="hinhanh2" ></div>
