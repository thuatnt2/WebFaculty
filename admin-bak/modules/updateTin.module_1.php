...
if (isset($_POST['btupdateTin'])) {
    ...
    if (!isset($_GET['sua'])) {
        ...
        $capnhat = "UPDATE tbltintuc SET tieude='$tieude',noidung='$noidung', ngaythang='$ngaythang', 
                     id_theloai='$id_theloai', ten_anh='$ten_anh', hien_an='$hien_an'
...
<div id="formbox"> 
    ...
    <form method="POST" name="AddnewINF" action="" enctype="multipart/form-data">     
        ...
        <div class="form-regit">
            ...
            <div class="value"><textarea rows="5" cols="42" name="noidung" id="noidung"><?php echo $row1['noidung']; ?></textarea></div>
        </div> 
