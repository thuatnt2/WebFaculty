            ...
            if($_FILES["fileUpload"]["error"] > 0) {
                ...
                if(!file_exists($path)) {
                    move_uploaded_file($_FILES['fileUpload']['tmp_name'], $path);                  
                      $ins = "INSERT INTO  tbl_thongbaogv(tenTB,ndTB,idGV,date,idLoai,anh,hien_an) 
...
<div id="formbox"> 
        ...
        <div class="form-regit">
            ...
            <div class="value">
                                    ...
                                    <option value=""></option>
					<?php
						$sql="SELECT * FROM tbl_theloaitbgv where idGV= $id";
         ...
         <div class="form-but">
           ...
           <div class="clear"></div>
                 <div class="link"><a href="index.php?mod=quanliTintucBloggv">Xem danh sách tin </a> </div>     	
          </div>      
        </form>
        <div class="clear"></div>
