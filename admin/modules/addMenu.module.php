...
<?php
    ...
    if(isset($_POST['btaddTL'])){
        ...
        $ins = "INSERT INTO tblmenuchinh(tenMnChinh) 
                    VALUES('$ten_theloai')";		
        $kq=mysql_query($ins);
        if($kq){
...
?>
 <div id="formbox"> 
        ...
        <form method="POST" name="updateTL" action="">     
            ...
            <div class="label">Tên Menu Chính  </div>
           ...
           <div class="form-but">
                ...
                <div class="clear"></div>
                 <div class="link"><a href="index.php?mod=quanliMenu">Xem danh sách Menu Chính</a> </div>     	
            </div>      
        </form>
        <div class="clear"></div>
